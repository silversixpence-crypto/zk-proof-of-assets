...
BUILD_DIR=./build/pedersen
CIRCUIT_NAME=pedersen_commitment
SIGNALS=./scripts/pedersen_inputs.json
...
\time --quiet circom "$CIRCUITS_DIR"/"$CIRCUIT_NAME".circom --r1cs --wasm --sym --c --wat --output "$BUILD_DIR" -l ../node_modules -l ../git_modules
