...
include "../git_modules/circom-ecdsa/circuits/bigint.circom";
include "../git_modules/circom-ecdsa/circuits/ecdsa.circom";
include "../git_modules/circom-ecdsa/circuits/bigint_func.circom";
...
template Secp256K1ScalarMultCachedWindowed(n, k) {
    ...
    var coefficients = 1 << stride;

    signal input scalar[k];
    signal input pointPreComputes[num_strides][coefficients][2][k];
